...
describe("sale test 2", function () {
  ...
  it("User1 tries to purchase with 5000 ETH", async function () {
    console.log("******************************************************");
    console.log(
      "User1 ETH balance: ",
    ...
    await sale
      .connect(user1)
      .purchaseFor(user1.address, { value: fiveThousand });
    console.log(
      "User1 ETH balance: ",
      divDec(await ethers.provider.getBalance(user1.address))
    );
  ...
  it("User2 tries to purchase with 2000 ETH", async function () {
    console.log("******************************************************");
    console.log(
      "User2 ETH balance: ",
    ...
    console.log("User2 purchases with 2000 ETH");
    await sale
      .connect(user2)
      .purchaseFor(user2.address, { value: twoThousand });
    console.log(
      "User2 ETH balance: ",
      divDec(await ethers.provider.getBalance(user2.address))
    );
  ...
  it("User1 tries to purchase with 2000 ETH for user0", async function () {
    console.log("******************************************************");
    console.log(
      "User1 ETH balance: ",
      divDec(await ethers.provider.getBalance(user1.address))
    ...
    console.log("User1 purchases with 2000 ETH for user0");
    await sale
      .connect(user1)
      .purchaseFor(user0.address, { value: twoThousand });
    console.log(
      "User1 ETH balance: ",
      divDec(await ethers.provider.getBalance(user1.address))
    );
  ...
  it("Sale State", async function () {
    ...
    console.log("Sale State");
    console.log("Token: ", await sale.token());
    console.log("Total Amount: ", divDec(await sale.totalAmount()));
    console.log("Total Claim: ", divDec(await sale.totalClaim()));
    console.log("Total Refund: ", divDec(await sale.totalRefund()));
    console.log("Sale State: ", await sale.state());
    console.log(
      "ETH Balance: ",
      divDec(await ethers.provider.getBalance(sale.address))
  ...
  it("User3 tries to purchase with 2000 ETH", async function () {
    ...
    await expect(
      sale.connect(user3).purchaseFor(user3.address, { value: twoThousand })
    ).to.be.revertedWith("Sale__MaxCapReached");
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user3.address))
    );
  ...
  it("User3 tries to purchase with 1000 ETH", async function () {
    ...
    await sale
      .connect(user3)
      .purchaseFor(user3.address, { value: oneThousand });
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user3.address))
    );
  ...
  it("State moved forward to claim", async function () {
    ...
    await token.mint(owner.address, twentyThousand);
    await token.approve(sale.address, twentyThousand);
    await sale.updateState();
    console.log("Sale State: ", await sale.state());
  });
