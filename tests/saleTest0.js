...
describe("sale test 0", function () {
  ...
  it("User1 tries to purchase with 10 ETH", async function () {
    ...
    await sale.connect(user1).purchaseFor(user1.address, { value: ten });
    console.log(
      "User1 ETH balance: ",
      divDec(await ethers.provider.getBalance(user1.address))
    );
  ...
  it("User2 tries to purchase with 10 ETH", async function () {
    ...
    await sale.connect(user2).purchaseFor(user2.address, { value: ten });
    console.log(
      "User2 ETH balance: ",
      divDec(await ethers.provider.getBalance(user2.address))
    );
  ...
  it("User1 tries to purchase with 10 ETH for user0", async function () {
    ...
    await expect(
      sale.connect(user1).purchaseFor(user0.address, { value: ten })
    ).to.be.revertedWith("Sale__NotWhitelisted");
    console.log(
      "User0 ETH balance: ",
      divDec(await ethers.provider.getBalance(user0.address))
  ...
  it("User1 tries to purchase with 20 ETH for user0", async function () {
    console.log("******************************************************");
    console.log(
      "User1 ETH balance: ",
      divDec(await ethers.provider.getBalance(user1.address))
    ...
    console.log("User1 purchases with 20 ETH for user0");
    await sale.connect(user1).purchaseFor(user0.address, { value: twenty });
    console.log(
      "User1 ETH balance: ",
      divDec(await ethers.provider.getBalance(user1.address))
    );
  ...
  it("User3 tries to purchase with 20 ETH", async function () {
    console.log("******************************************************");
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user1.address))
    ...
    console.log("User3 purchases with 20 ETH");
    await sale.connect(user3).purchaseFor(user3.address, { value: twenty });
    console.log(
      "User3 ETH balance: ",
  ...
  it("State moved forward to refund", async function () {
    console.log("******************************************************");
    console.log("Sale State: ", await sale.state());
    await sale.updateState();
    console.log("Sale State: ", await sale.state());
  ...
  it("User3 tries to purchase with 20 ETH", async function () {
    ...
    console.log("User3 purchases with 20 ETH");
    await expect(
      sale.connect(user3).purchaseFor(user3.address, { value: twenty })
    ).to.be.revertedWith("Sale__NotOpen");
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user3.address))
  ...
  it("User3 tries to claim", async function () {
    console.log("******************************************************");
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user3.address))
    ...
    ).to.be.revertedWith("Sale__NotClaim");
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user3.address))
    );
  ...
  it("User3 gets refund", async function () {
    console.log("******************************************************");
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user3.address))
    ...
    await sale.connect(user3).refundFor(user3.address);
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user3.address))
    );
  ...
  it("User3 tries to get refund", async function () {
    ...
    ).to.be.revertedWith("Sale__InvalidRefund");
    console.log(
      "User3 ETH balance: ",
      divDec(await ethers.provider.getBalance(user3.address))
    );
  ...
  it("Everyone else refunds", async function () {
    console.log("******************************************************");
    await sale.refundFor(user0.address);
    await sale.connect(user1).refundFor(user1.address);
    await sale.connect(user1).refundFor(user2.address);
    await expect(
      sale.connect(user1).refundFor(user3.address)
    ).to.be.revertedWith("Sale__InvalidRefund");
  });
  ...
  it("State moved forward", async function () {
    console.log("******************************************************");
    console.log("Sale State: ", await sale.state());
    await expect(sale.updateState()).to.be.revertedWith("Sale__Concluded");
    console.log("Sale State: ", await sale.state());
  });
