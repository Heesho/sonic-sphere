...
describe("farmPluginSplitTest", function () {
  ...
  it("Test auction interactions", async function () {
    ...
    await LP0.connect(user1).approve(router.address, currentPrice);
  ...
  it("Test auction edge cases", async function () {
    ...
    await LP0.connect(user1).approve(router.address, currentPrice.div(2));
